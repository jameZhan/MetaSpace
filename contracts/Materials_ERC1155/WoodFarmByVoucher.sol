...
contract WoodFarmByVoucher is Ownable, IVNFTReceiver, IERC721Receiver, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // This contract is wood Farm, tokenId = 2
    uint256 public materialId = 2;
    ...
    constructor(
        ...
        devaddr = _msgSender();
        materialPerBlock = 8;     // decimal: 1e0
