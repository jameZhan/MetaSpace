...
contract StoneAdvancedFactory is Context, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function _setFactoryAttributes() private {
        _currentAttributes[1] = FactoryAttributes({
                                                    ...
                                                    singleProcessPeriod: 13 seconds,
                                                    singleProcessPrice: 306 * 1e12,
                                                    productionLineLimit: 1,
                                                    updateMaterialNeeded: 54000
                                                });

        _currentAttributes[2] = FactoryAttributes({
                                                    processLimit: 6480,
                                                    baseSuccessRate: 2850,
                                                    singleProcessPeriod: 10 seconds,
                                                    singleProcessPrice: 292 * 1e12,
                                                    productionLineLimit: 1,
                                                    updateMaterialNeeded: 270000
                                                });
        _currentAttributes[3] = FactoryAttributes({
                                                    ...
                                                    updateMaterialNeeded: 540000
                                                });
        _currentAttributes[4] = FactoryAttributes({
                                                    processLimit: 7920,
                                                    baseSuccessRate: 3300,
                                                    singleProcessPeriod: 6 seconds,
                                                    singleProcessPrice: 264 * 1e12,
                                                    productionLineLimit: 2,
                                                    updateMaterialNeeded: 2700000
                                                });
        _currentAttributes[5] = FactoryAttributes({
                                                    processLimit: 8640,
                                                    baseSuccessRate: 3600,
                                                    singleProcessPeriod: 5 seconds,
                                                    singleProcessPrice: 250 * 1e12,
                                                    productionLineLimit: 3,
                                                    updateMaterialNeeded: 27000000
                                                });
        _currentAttributes[6] = FactoryAttributes({
                                                    processLimit: 10800,
                                                    baseSuccessRate: 4500,
                                                    singleProcessPeriod: 3 seconds,
                                                    singleProcessPrice: 139 * 1e12,
                                                    productionLineLimit: 3,
