...
contract WoodAdvancedFactory is Context, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function _setFactoryAttributes() private {
        _currentAttributes[1] = FactoryAttributes({
                                                    processLimit: 6000,
                                                    baseSuccessRate: 3200,
                                                    singleProcessPeriod: 12 seconds,
                                                    singleProcessPrice: 147 * 1e12,
                                                    productionLineLimit: 1,
                                                    updateMaterialNeeded: 90000
                                                });

        _currentAttributes[2] = FactoryAttributes({
                                                    processLimit: 6750,
                                                    baseSuccessRate: 3800,
                                                    singleProcessPeriod: 9 seconds,
                                                    singleProcessPrice: 140 * 1e12,
                                                    productionLineLimit: 1,
                                                    updateMaterialNeeded: 450000
                                                });
        _currentAttributes[3] = FactoryAttributes({
                                                    ...
                                                    updateMaterialNeeded: 900000
                                                });
        _currentAttributes[4] = FactoryAttributes({
                                                    processLimit: 8250,
                                                    baseSuccessRate: 4400,
                                                    singleProcessPeriod: 5 seconds,
                                                    singleProcessPrice: 127 * 1e12,
                                                    productionLineLimit: 2,
                                                    updateMaterialNeeded: 4500000
                                                });
        _currentAttributes[5] = FactoryAttributes({
                                                    processLimit: 9000,
                                                    baseSuccessRate: 4800,
                                                    singleProcessPeriod: 4 seconds,
                                                    singleProcessPrice: 120 * 1e12,
                                                    productionLineLimit: 3,
                                                    updateMaterialNeeded: 45000000
                                                });
        _currentAttributes[6] = FactoryAttributes({
                                                    processLimit: 11250,
                                                    baseSuccessRate: 6000,
                                                    singleProcessPeriod: 3 seconds,
                                                    singleProcessPrice: 67 * 1e12,
                                                    productionLineLimit: 3,
