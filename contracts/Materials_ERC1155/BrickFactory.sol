...
contract BrickFactory is Context, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function _setFactoryAttributes() private {
        _currentAttributes[1] = FactoryAttributes({
                                                    ...
                                                    singleProcessPrice: 110 * 1e12,
                                                    productionLineLimit: 1,
                                                    updateMaterialNeeded: 100000
                                                });

        _currentAttributes[2] = FactoryAttributes({
                                                    processLimit: 4500,
                                                    baseSuccessRate: 4750,
                                                    singleProcessPeriod: 9 seconds,
                                                    singleProcessPrice: 105 * 1e12,
                                                    productionLineLimit: 1,
                                                    updateMaterialNeeded: 500000
                                                });
