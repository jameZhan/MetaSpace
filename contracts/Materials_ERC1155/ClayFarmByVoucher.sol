...
contract ClayFarmByVoucher is Ownable, IVNFTReceiver, IERC721Receiver, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // This contract is Clay Farm, tokenId = 1
    ...
    constructor(
        ...
        devaddr = _msgSender();
        materialPerBlock = 10;     // decimal: 1e0
