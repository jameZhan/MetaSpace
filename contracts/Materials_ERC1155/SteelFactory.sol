...
contract SteelFactory is Context, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function _setFactoryAttributes() private {
        _currentAttributes[1] = FactoryAttributes({
                                                    ...
                                                    singleProcessPeriod: 14 seconds,
                                                    singleProcessPrice: 330 * 1e12,
                                                    productionLineLimit: 1,
                                                    updateMaterialNeeded: 50000
                                                });
        ...
        _currentAttributes[2] = FactoryAttributes({
                                                    ...
                                                    singleProcessPrice: 315 * 1e12,
                                                    productionLineLimit: 1,
                                                    updateMaterialNeeded: 250000
                                                });
